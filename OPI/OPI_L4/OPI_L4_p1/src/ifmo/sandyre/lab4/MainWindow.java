...
public class MainWindow extends JPanel {
    ...
    public MainWindow()
    {
        ...
        try {
            ObjectName area_mbean = new ObjectName("ifmo.sandyre.lab4:type=AreaMBean");
            ObjectName shots_mbean = new ObjectName("ifmo.sandyre.lab4:type=ShotsMBean");

            mbs.registerMBean(draw.getAreaComputer(), area_mbean);
            mbs.registerMBean(draw.getShotsController(), shots_mbean);
        } catch(Exception e) {
