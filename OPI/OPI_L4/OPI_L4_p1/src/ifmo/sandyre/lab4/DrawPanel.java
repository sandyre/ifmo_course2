...
public class DrawPanel extends JPanel {
    ...
    private AreaComputer area_computer = new AreaComputer(R);
    private ShotsController shots_controller = new ShotsController();
    private HashSet<Punto> points = new HashSet<Punto>();
    private JTextField coordsField;

    public AreaComputer getAreaComputer()
    {
    ...
    public void AddNewPoint(int x, int y)
    {
        ...
        {
            shots_controller.refresh_and_add_shot(true);
            punto.setCurrentState(true);
        }
        else
        {
            totalshots++;
            shots_controller.refresh_and_add_shot(false);
    ...
    public void SetRadius(int Radius)
    {
        ...
        area_computer.setRadius(R);
        area_computer.refreshArea();
        ...
        shots_controller.radiusChanged(successshots);
